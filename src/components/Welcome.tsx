  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6'>
        ...
        className="flex items-center justify-center gap-10 mt-10">
            <ShoppingBasket className="w-24 h-24 md:w-32 md:h-32 text-gray-600 drop-shadow-md"/>
        ...
        className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-2xl shadow-md cursor-pointer mt-10"
        onClick={()=>nextStep(2)}
        >
            Next
            <ArrowRight/>
