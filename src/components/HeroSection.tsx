...
const HeroSection = () => {
    const slides = [
  {
    ...
    btnText: "Shop Now",
    bg: "https://images.unsplash.com/photo-1518843875459-f738682238a6?q=80&w=1142&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", 
  },
  {
    id: 2,
    icon: (
  ...
  },
  {
    ...
    btnText: "Explore",
    bg: "https://images.unsplash.com/photo-1557844352-761f2565b576?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", 
  },
];
    ...
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl '>
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
                ...
                >
                  ...
                  <p className='text-lg sm:text-xl text-gray-510 max-w-2xl'>
